...
- [TabOut](https://marketplace.visualstudio.com/items?itemName=albert.TabOut) or [Leaper](https://marketplace.visualstudio.com/items?itemName=OnlyLys.leaper)
...
- [Typescript React hooks Tools](https://marketplace.visualstudio.com/items?itemName=kingwl.ts-react-hooks-tools)

## Linting and code quality

- [ESLint](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint)
- [HTMLHint](https://marketplace.visualstudio.com/items?itemName=HTMLHint.vscode-htmlhint)
- [Stylelint](https://marketplace.visualstudio.com/items?itemName=stylelint.vscode-stylelint) or [stylelint-plus](https://marketplace.visualstudio.com/items?itemName=hex-ci.stylelint-plus)
...
- [Markdown Footnes](https://marketplace.visualstudio.com/items?itemName=bierner.markdown-footnotes)
...
- [Always-on Next.js TypeScript Plugin](https://marketplace.visualstudio.com/items?itemName=shuding.next-ts-plugin-vscode)
- [flocli](https://marketplace.visualstudio.com/items?itemName=dylanintech.flocli)
...
- [Polacode](https://marketplace.visualstudio.com/items?itemName=pnp.polacode) or [CodeSnap](https://marketplace.visualstudio.com/items?itemName=adpyke.codesnap)
...
- [GitHub Theme](https://marketplace.visualstudio.com/items?itemName=thomaspink.theme-github)
